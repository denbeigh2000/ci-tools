...
def build_derivations_step(derivs: Sequence[DerivationInfo]) -> Dict[str, Any]:
    ...
    return {
        ...
        # TODO: We should have a way of overriding/pinning this so we can
        # allow users to pin to the versions they're using.
        "command": f"nix run github:denbeigh2000/ci-tools#default -- build-derivations {targets}",
    }
